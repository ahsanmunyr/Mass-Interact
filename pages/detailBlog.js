    ...
    <div className="container-1200 py-5">
       <div className="row">
          ...
          <div data-aos="fade-up"  className="img-item blogImage">
          {
                ...
                <Image src={filteredData[0].img.default} placeholder='blur' />
                ...
                <ol>
                   {
                      filteredData[0].points.map((item, index)=>
                          ...
                          <li  data-aos="fade-up"  key={item.no}><span>{item.heading} – </span>{item.des}</li>
             ...
             <div data-aos="fade-up" className="blog-comments">
                <div className="row">
                   ...
                   <div className="col-lg-12 px-1 d-flex">
                      ...
                      <label className="my-auto" for="saveinfo">Save my name, email, and website in this browser for the next time I comment.</label>
                   </div>
