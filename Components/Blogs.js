...
function BlogSection({array, array1}) {
        ...
        
         {
          ...
          <div className="col-xl-4 col-lg-4 col-md-4 ">
             <div className="latest-post">
               ...
               {/* date: "2021-10-26"
               id: 2
               image: "upload/blog_images/6177e0800a77d.jpg"
               title: "update check" */}
                {
                filteredData1.map((item, index)=>(
                  ...
                  <div className="post-des">
                     ...
                     <span > <FontAwesomeIcon color="#f65c2a" icon={faCalendar}></FontAwesomeIcon> {item.date} </span>
                      {/* <span > <i className="fa fa-tags px-2"> </i>  Virtual Tours </span> */}
                   </div>
                </div>
                ))
                }
             ...
             <div className="inner-tags">
                {/* <p onClick={()=> setFilteredData('audio')}>audio</p> */}
                <p>audio</p>
                <p>food</p>
                <p>travel</p>
                <p>event</p>
